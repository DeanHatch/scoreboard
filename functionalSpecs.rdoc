...
*  Public Display Viewers - These are the fans of the teams that are participating in the contests. 
   Collectively, all the contests and teams and groups of teams are called a "Competition." These people can view
   a Competition but they cannot change any of the scores or schedules or anything else.
*  Scorers - These people can view everything and they can record scores for any of the contests in
   the Competition. They cannot, however, schedule or re-schedule any of the contests or manage the
...
because 24 was a no-show and 24 played 12 on Court 1 at 12, not 12 at 1.
...
taped to the walls throughout the facility.  
...
* Forfeits will not be automatically handled.
...
the navigation links. In the main content, a stus message and other informational
...
This page will serve as a welcome page to wandering visitors. It will provide
...
In addition to the Navigation Panel on the left, this Manager Page 
...
This Manager Page will allow the Manager to change or correct the name
