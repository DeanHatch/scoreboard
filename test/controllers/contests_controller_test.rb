...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { date: @contest.date, status: @contest.status, time: @contest.time, venue_id: @contest.venue_id }
    end
  ...
  test "should update contest" do
    patch :update, id: @contest, contest: { date: @contest.date, status: @contest.status, time: @contest.time, venue_id: @contest.venue_id }
    assert_redirected_to contest_path(assigns(:contest))
  end
